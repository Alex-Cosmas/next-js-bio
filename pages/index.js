...
const Home = () => (
  <div className='font-body hero bg-gray-900 h-3'>
    <Head>
      <title>
        Alex Cosmas: Full Stack Designer | UX | Product Design | Frontend
        Developer
      </title>
    ...
    <div className='container mx-auto px-4 md:px-32'>
      <div className='flex mt-8 space-y-5 justify-between'>
        <div className='w-full md:w-3/5'>
          ...
          <div className='text-gray-600 mb-3 text-base'>
            I am at Sokoplace Group as a contracted consultant refactoring the
            exising designs and building internal tools. I as well manage my own
            Consultancy WabiSabi Technologies.
          </div>

          <h1 className='text-gray-600 mb-3 font-medium'>Skills & Tools</h1>
          ...
          <div className='text-gray-600 mb-3 text-base'>
            ...
            <strong>
              <span>
                {' '}
                Old Fashioned Pen and Paper(Occasionally Sticky Notes &
                Whiteboard),{' '}
              </span>
            </strong>
            <strong>
          ...
          <h1 className='text-gray-600 mb-3 font-medium'>Deployment</h1>

          <div className='text-gray-600 mb-3 text-base'>
            I have experience working with Docker, Heroku, Digital Ocean.
            Currently, I am working with Vercel/Netlify and on occasion I switch
            back.
          </div>

          <h1 className='text-gray-600 mb-3 font-medium'>Novice</h1>

          <div className='text-gray-600 mb-3 text-base'>
            Currently experimenting on Typescript, Ruby on Rails and
            Elixir/Phoenix/Live view.
          </div>

          <p className='text-gray-600 mb-3 text-base'>
            You can reach me through the contacts below.{' '}
            <strong>I am open to new opportunities. </strong>
          </p>
        </div>
      ...
      <div className='grid sm:grid-cols-3  grid-cols-1 gap-3'>
        ...
        >
          ...
          <div className=' p-4'>
            ...
            <div className='mt-3 text-base text-gray-700'>
              Safety Administrate is an API based enterprise training management
              web application manages delegate bookings and automates checkouts,
        ...
        >
          ...
          <div className=' p-4 h-full'>
            <div className='flex items-center'>
              <h3 className='text-lg font-semibold text-gray-800'>Sokoplace</h3>
            ...
            <div className='mt-3 text-base text-gray-700'>
              Sokolace is a logistics, warehousing and fulfillment SAAS solution
              for B2B and B2C business.
            </div>
            <div className='mt-2'>
              <span className=' align-bottom inline-flex items-center px-2 py-0.5 rounded text-xs font-medium leading-4 bg-gray-100 text-gray-800 mr-2'>
                Ongoing Project
              </span>
            </div>
          </div>
        ...
        >
          ...
          <div className=' p-4'>
            ...
            <div className='mt-3 text-base text-gray-700'>
              Kiota is a multi-tenant application that allows users to manage
              receipts and invoices from one dashboard without switching
              accounts.
            </div>
            <div className='mt-2'>
              <span className='inline-flex items-center px-2 py-0.5 rounded text-xs font-medium leading-4 bg-gray-100 text-gray-800 mr-2'>
        ...
        <a
          href='https://www.notion.so/Strapi-UI-Rebranding-Design-System-Update-800266001eac4efc844f38a526e44cfa'
          target='_blank'
          className='rounded-lg shadow bg-white cursor-pointer overflow-hidden transition-all duration-200 group hover:shadow-lg'
          style={{ filter: 'grayscale(0%)', transform: 'none', opacity: 1 }}
        >
          ...
          <div className=' p-4'>
            <div className='flex items-center'>
              <h3 className='text-lg font-semibold text-gray-800'>Strapi</h3>
            ...
            <div className='mt-3 text-base text-gray-700'>
              Strapi is an open-source software platform based in Paris, France
              that helps developers to easily build, deploy, and manage APIs.
            </div>
            <div className='mt-2'>
              <span className='inline-flex items-center px-2 py-0.5 rounded text-xs font-medium leading-4 bg-gray-100 text-gray-800 mr-2'>
                Ongoing
        ...
        >
          ...
          <div className=' p-4'>
            ...
            <div className='mt-3 text-base text-gray-700'>
              Mtaani Online is an niched advertising platform built to focus on
              individuals and small business within the same locale helping them
      ...
      {/* https://www.notion.so/Safety-Systems-Administrate-37be307390b544cf809b0871002909e0 */}
